/*!
 中国电子口岸数据中心,JavaScript Library v1.2.8 For 客户端控件 v1.5.3
 http://www.chinaport.gov.cn
 Date:2017年4月25日
 LastModifyDate:2018年07月28日
 */
(function (window, document, navigator) {
  ...
  var isIE6789 = function () {
    ...
    var trimVersion = (version.length > 1) ? version[1].replace(/[ ]/g, '') : ''
    return navigator.appName === 'Microsoft Internet Explorer' && (trimVersion === 'MSIE6.0' || trimVersion === 'MSIE7.0' || trimVersion === 'MSIE8.0' || trimVersion === 'MSIE9.0')
  }
