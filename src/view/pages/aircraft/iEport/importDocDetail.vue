<template>
  <section class='airvehicle-main'>
    ...
    <el-row class="airvehicle-panel airvehicle-form">
      <el-form label-width="165px" :model="submitData" ref="submitData" :rules="rules">
        ...
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item label="抵达港口" prop="arrivalPort">
              ...
              <span v-else>{{submitData.arrivalPort}}-{{submitData.arrivalPortValue}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
          ...
          <el-col :span="6">
            <el-form-item label="是否发现外来有害生物" prop="harmfulOrganisms">
              ...
              <span v-else v-text="submitData.harmfulOrganisms === '1'?'是':'否'"></span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="是否有有效灭蚊证明" prop="mosquitoEradication">
              ...
              <span v-else v-text="submitData.mosquitoEradication === '1'?'是':'否'"></span>
            </el-form-item>
          </el-col>
        </el-row>
    ...
    <el-row class="airvehicle-panel airvehicle-table">
      ...
      <el-table class='sys-table-table mg-b-30' max-height="250" :data="submitData.cdsAirMemberVO" border highlight-current-row size="mini" @selection-change="selectVal">
