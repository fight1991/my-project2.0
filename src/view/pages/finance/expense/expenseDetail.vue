  ...
  <section class='sys-main expenseDetail'>
    ...
    <div class="receive area">
      ...
      <div class='query-table'>
        <el-table class='sys-table-table' :cell-class-name="getCellStyle" align="left" :data="billReceivableBodyVO.billReceivableBodyVOList" border>
          ...
          <el-table-column prop="billType" min-width="120" label="使用报价" align="center">
          </el-table-column>
          <el-table-column prop="billType" width="80" label="操作人" align="center">
          </el-table-column>
        </el-table>
      </div>
    </div>
...
export default {
  ...
  created () {
    let id = this.$route.query.expenseBillId
