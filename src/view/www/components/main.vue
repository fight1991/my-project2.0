      ...
      <div class="content mainer">
        ...
        <div class="detail clearfix">
          ...
          <div class="item text">
            ...
            <p>可以将各个客户端的不同清单数据,自动抓取形成标准的清单模板,一键生成报关单,避免出错轻松录入。</p>
          </div>
          <div class="item">
          ...
          <div class="item text">
            ...
            <p>采用官方制单校验规则,进行风险预警及二次复核,确保申报合规,自动生成标准版单证清单;分析操作员历史制单情况,提供参考模板,提高制单准确率及效率.</p>
          </div>
          <div class="item">
          ...
          <div class="item text">
            ...
            <p>基于海量数据支持,进行大数据分析,通过平台的数据分析、算法的精确匹配,从而辅助决策、提供相应的报表,真正走在智能化潮流的前端.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      pro: [
        {
          ...
          up: '平台由中国报关协会联合搭建联合运营,行业权威优势的体现。',
          down: '在中国报关协会的监督下,合力提供一个安全、公平、统一的运营环境,行业信息的及时传递。'
        },
        {
          imgURL: require('@/assets/www-img/images/pro02.png'),
          up: '行业深耕超过15年,关务信息化行业领导者。',
          down: '行业一流团队,为众多报关、货代、世界500强知名进出口企业提供公关信息服务产品。'
        },
        {
          imgURL: require('@/assets/www-img/images/pro03.png'),
          up: '优秀的通关信息化管理整体解决方案咨询专家。',
          down: '可根据企业关务、通关管理的现状以及问题点,为企业制定最优通关信息化管理解决方案。'
        }
      ],
      list: [
        {
          ...
          title: '无纸化单证自动转换',
          text: '原来，客户提供电子档的资料需要打印单证，然后统一扫描，再上传到单一窗口，现在，WORD、PDF、EXCEL等自动生成复核无纸化申报要求的文件格式，省去打印和扫描的步骤，轻松提效50%以上。'
        },
        {
        ...
        },
        {
          ...
          title: '通关状态全透明',
          text: '通关报关数据实时同步，随时了解通关进度，方寸之间尽显从容。'
        },
        {
          imgURL: require('@/assets/www-img/images/ef04.png'),
          title: '制单风险预警',
          text: '通过数据化的演示，实时统计制单易错点，在制单过程中，自动警示历史易错点，显著提高制单的正确率。清晰列出操作员历史累计错误和统计，为企业培训和操作员技能优化提供了有效的数据支持。'
        },
        {
          imgURL: require('@/assets/www-img/images/ef05.png'),
          title: '商品数据库',
          text: '申报录单自动提示选取，一次录入即可反复使用，制单速度提效80%。'
        }, {
