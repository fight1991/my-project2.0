  ...
  methods: {
    ...
    pageList (pagination) {
      ...
      if (this.dates === '' || this.dates === null) {
        this.QueryForm.arrivalDateTimeStart = ''
        this.QueryForm.arrivalDateTimeEnd = ''
      } else {
        this.QueryForm.arrivalDateTimeStart = util.dateFormat(this.dates[0], 'yyyy-MM-dd')
        this.QueryForm.arrivalDateTimeEnd = util.dateFormat(this.dates[1], 'yyyy-MM-dd')
      }
