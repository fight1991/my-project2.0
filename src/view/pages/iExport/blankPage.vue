...
export default {
  ...
  mounted () {
    if (this.$route.name === 'tax_I_Template') { // 进口核注清单模板
      ...
      this.url = pathList.eImport['taxInfo'] + '?sysId=CCBA&tabId=' + this.$route.name
    }
  }
}
</script>
