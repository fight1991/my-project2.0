<template>
  <section class='sys-main'>
    ...
    <div class="query-header">
      <el-row :gutter="20">
        <el-col :span="6">
          <el-input size="mini" v-model="countryForm.keywords" placeholder="国别代码/国别名称" maxlength="50" clearable @keyup.enter.native="search"></el-input>
        </el-col>
        <el-col :span="10">
    ...
    <div class='query-body'>
      <el-table class='sys-table-table' :data="countryList" border highlight-current-row size="mini">
        ...
        <el-table-column label="国别名称" min-width="150">
          <template slot-scope="scope">
            <div class='sys-td-l'>{{scope.row.countryNa}}</div>
          </template>
        </el-table-column>
        <el-table-column label="英文名称" min-width="150">
          <template slot-scope="scope">
            <div class='sys-td-l'>{{scope.row.countryEn}}</div>
          </template>
        </el-table-column>
      </el-table>
      <!--分页-->
