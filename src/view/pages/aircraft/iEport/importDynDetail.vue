    ...
    <el-form :label-width="isEdit?labelFormWidth.sixR:'130px'" :model="submitData" ref="submitData" :rules="rules" class="airvehicle-form-b" size="mini">
      ...
      <el-row class="airvehicle-panel">
          ...
          <el-row :gutter="30" class="pd-l-15 mg-b-10">
            ...
            <el-col :span="6">
              <el-form-item :label="isEdit?'抵港时间':'抵港时间：'" prop="arrivalDateTime">
                <el-date-picker size="mini"  v-model="submitData.arrivalDateTime" type="datetime" v-if="isEdit" style="width:100%"></el-date-picker>
                <span v-else class="color-txt">{{submitData.arrivalDateTime | date()}}</span>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item :label="isEdit?'卸机时间':'卸机时间：'">
                ...
                <span v-else class="color-txt">{{submitData.dischargeCompleteDateTime | date()}}</span>
              </el-form-item>
            </el-col>
          </el-row>
